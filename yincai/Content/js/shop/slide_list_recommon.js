...
function slider_rc() {
    var $next = $('.rc_next');//右边下一个按钮
    var $prev = $('.rc_prev');//左边上一个按钮
    var $mainlist = $('.rc_mainlist'); //主要内容
    var $swaplist = $('.rc_swaplist'); //被自制的内容，主要用于左边
    var $list = $('.rc_swaplist,.rc_mainlist');//左右内容同时
    var $li = $('.rc_mainlist li');//计算li
    var width = 908;//总宽度＝ul_width*imgList
    var ul_width = 227;//ul宽度
    var imgList = 4;//图片摆放张数
...
$(document).ready(function () {
    $('.rc_prev,.rc_next').hover(function () {
