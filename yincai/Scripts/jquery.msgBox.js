...
//var msgBox;
//$(function () {
//    msgBox = new MsgBox({ imghref: "/Content/Images/msgBox/" });
//});
(function () {
    function MsgBox(s) {
        ...
        function setPosition() {
            ...
            tp = window.top.screen.height / 2 - 200 + window.top.document.documentElement.scrollTop;
    ...
    $(function () {
        $.extend($, {
            msgBoxObj: new MsgBox({ imghref: "/Content/Images/msgBox/" })
        });
    });
})();
